...
public class TorchBlock extends BlockWithEntity
{
    ...
    public <T extends BlockEntity> BlockEntityTicker<T> getTicker(World world, BlockState state, BlockEntityType<T> type) {
        if (world.isClient)
        {
            return TorchBlock.checkType(type, ModBlockEntities.TORCH, TorchBlockEntity::clientTick);
        }
        else
        {
            return TorchBlock.checkType(type, ModBlockEntities.TORCH, TorchBlockEntity::serverTick);
        }
    }
}
