...
public class StoneOvenBlockEntityRenderer implements BlockEntityRenderer<StoneOvenBlockEntity> {

    public StoneOvenBlockEntityRenderer(BlockEntityRendererFactory.Context ctx) {
    }
    ...
    @Override
    public void render(StoneOvenBlockEntity entity, float tickDelta, MatrixStack matrices, VertexConsumerProvider vertexConsumers, int light, int overlay) {
        ...
        Direction facing = entity.getCachedState().get(StoneOvenBlock.FACING);
