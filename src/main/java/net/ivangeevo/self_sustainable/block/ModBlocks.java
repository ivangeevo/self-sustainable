...
import net.ivangeevo.self_sustainable.block.blocks.WallTorchBlock;
...
public class ModBlocks {
    ...
    public static final Block TORCH = registerBlockWithoutItem("torch",
            new TorchBlock(FabricBlockSettings.create()
                    .noCollision()
                    .breakInstantly()
                    .luminance(state -> 14)
                    .sounds(BlockSoundGroup.WOOD)
    ...
    public static final Block WALL_CRUDE_TORCH = registerBlockWithoutItem("wall_crude_torch",
            new WallTorchBlock(FabricBlockSettings.create()
                    .noCollision()
                    .breakInstantly()
                    .luminance(state -> 14)
                    .sounds(BlockSoundGroup.WOOD)
